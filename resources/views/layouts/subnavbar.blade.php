  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="dropdown"><a href="{{Request::url()}}/permintaan" class="dropdown-toggle" data-toggle="dropdown"><i class='icon-hand-up'></i><span>Pengajuan</span><b class="caret"></b></a>
